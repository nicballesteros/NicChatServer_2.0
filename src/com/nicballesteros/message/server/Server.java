...
public class Server implements Runnable{
    ...
    private List<Message> getMessageHistory(ServerClient client){
        ...
        try{
            ...
            String sql = "SELECT * FROM messages WHERE toid = " + client.getID() + " OR fromid = " + client.getID() + ";";
            ...
            while(rset.next()){
                ...
                messages.add(new Message(message, fromid, toid));
            }
        }
        catch(Exception e){
            e.printStackTrace();
